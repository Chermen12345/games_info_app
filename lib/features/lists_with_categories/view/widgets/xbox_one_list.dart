...
class XboxOneList extends StatefulWidget {
  XboxOneList({super.key});
  final _bloc = CategoryBloc();

  @override
  State<XboxOneList> createState() => _XboxOneListState();
}

class _XboxOneListState extends State<XboxOneList> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    widget._bloc.add(LoadCategories(1));
  }
